...
fun main() {
    ...
    WallService.add(Post(0, 131, 21091990,"Иван Васильевич меняет профессию", like1.count, 10, "Текст1", false, true, false, "reply"))
    WallService.add(Post(1, 155, 21108990,"Какой-то текст", like1.count, 10, "Текст1",false, true, false, "reply"))
    WallService.add(Post(2, 134, 22106990,"Какой-то текст 2", like1.count, 500, null,false, true, false, "edit"))
